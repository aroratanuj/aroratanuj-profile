...
export const baswareEngineerExperience: Experience = {
  ...
  startDate: '2008-11',
  endDate: '2016-09',
  description: 'Led the automation team building Selenium/Gherkin-based testing frameworks; worked across VB6, .NET, Java/Scala, and SQL-based stacks. Epic Owner for release verification, sprint testing, and product closure.',
  ...
  achievements: [
    ...
    'Wrote and optimized SQL queries for testing, debugging, and data analysis across web and desktop applications',
