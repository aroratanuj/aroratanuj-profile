...
const Hero = () => {
  return (
    <section id="about" className="min-h-screen flex items-start bg-gradient-to-br from-slate-50 via-white to-indigo-50 pt-12 md:pt-16 pb-8">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center lg:text-left mb-8">
          ...
          <h2 className="text-base md:text-lg text-gray-600 font-semibold mb-6">
            Product Leader | {totalExperienceText} in IT | {pmExperienceText} in Product Management
          </h2>
            ...
            <div className="relative">
              ...
              <div className="relative">
                <img
                  ...
                  className="w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full object-cover object-top border-4 border-white shadow-2xl"
                  loading="eager"
                />
              </div>
            </div>
        ...
        {/* Bottom Section - Key Areas + Quick Facts Aligned */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          {/* Quick Facts */}
          <div>
            <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Quick Facts</h3>
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl md:rounded-3xl p-6 text-white">
